...
Public Class FormAnalizadorIntermedio

    Private ReadOnly Analizador As New AnalizadorIntermedio()


    Private Sub FormAnalizadorIntermedio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
